        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-10 mt-lg-5 text-center">
            <div class="single-text owl-carousel">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Events</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Cacth up with the University's events and announcements. Be updated and register to events now!</p>
                <div data-aos="fade-up" data-aos-delay="100">
                </div>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Evaluations</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Evaluations are never this easy and exciting, go check out the events and start evaluating them all. Let the Unversity know how you feel about it. Comments and Suggestions? Go now!</p>
              </div>

              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">What's new?</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Don't forget to check out for the latest updates on events!</p>
              </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="">
            ...
            <p>See all the new and upcoming events of the University. Register, enjoy, and relax at the same time!</p>
          </div>
          ...
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <p>Made it easier for you, just provide your name and you're good to go.</p>
          </div>
                  ...
                  <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="owl-carousel slide-one-item-alt-text">
                      ...
                      <div>
                        ...
                        <p>Register an account on the register link above and log in.</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
              <h3 class="h3 mb-4 text-black">WUP Event and Evaluation System</h3>
              <p>Your event registration and evaluation is made easier now.</p>

            </div>

            <div class="mb-4">
              <ul class="list-unstyled ul-check success">
                <li>Accessible Evaluation</li>
                <li>Easy Registration</li>
                <li>Faster Attendance</li>
              </ul>
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <blockquote class="mb-5">
                <p>This will be a huge help for WU-P students especially for Organizations who are holding activities and events because of its reliability and accessibility in the new form of learning.</p>
              </blockquote>

              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="images/profilelogo.png" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Renz Yco S. Mendoza</p>
              </figure>
            </div>
          </div>
          <div>
            <div class="testimonial">
              ...
              <blockquote class="mb-5">
                <p>Awesome, Innovative, Brilliant! Big thumbs up for the creators this will be a very useful platform for the future generations to spread events , parties , and competitions.  For them to participate and be active.</p>
              </blockquote>
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="images/profilelogo.png" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Jeremiah A. Gomez</p>
              </figure>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote class="mb-5">
                <p>As a student nurse, who promote and maintain health, I am infavor for this kind of website because this limits the physical contact and it may serve as a means for every student, a very easy and convenient way. especially at times like this wherein social and physical contact is limited. This kind of website is a very good help to improve the system of our university.</p>
              </blockquote>
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="images/profilelogo.png" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Jossah Mae Miranda</p>
              </figure>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote class="mb-5">
                <p>WUP event system is really good lalo na ngayon time of pandemic mas magiging organize ang systema ng ating SSC and also ng university para mas magkaroon ng buhay at sigla ang ating event para sa ating  mga estudyante kahit online classes lamang.</p>
              </blockquote>
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="images/profilelogo.png" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Baby Raquel M. Del Parto</p>
              </figure>
          ...
          <div class="container">
            ...
            <div id="posts" class="row no-gutter">
              <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal7.jpg" class="item-wrap fancybox">
                  <span class="icon-search2"></span>
                  <img class="img-fluid" src="images/gal7.jpg">
                </a>
              </div>
              <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal8.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal9.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                ...
                <a href="images/gal10.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal11.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal12.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal13.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal14.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal20.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal21.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal17.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
              ...
              <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                <a href="images/gal18.jpg" class="item-wrap fancybox" data-fancybox="gallery2">
                  <span class="icon-search2"></span>
        ...
        <div class="row mb-5">
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span ></span>
              <a href="https://www.google.com.ph/maps/place/Wesleyan+University-Philippines/@15.4795684,120.9723698,17z/data=!3m1!4b1!4m5!3m4!1s0x33972927fa9084cb:0x7a5599f1890203af!8m2!3d15.4795684!4d120.9745585" style = "color:#00cc00;" target="_blank">Mabini Street Extension, Cabanatuan, Nueva Ecija 3100</a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-4">
              <span class="icon-phone d-block h2 text-success"></span>
              <span>+63 (044) 463-2162 / 463-2074</span>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-0">
              <span class="icon-mail_outline d-block h2 text-success"></span>
              <a href="http://wesleyan.edu.ph/" style = "color:#00cc00;" target="_blank">admin@wesleyan.edu.ph</a>
            </p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Send Message" class="btn btn-success btn-md text-white">
                </div>
              </div>
