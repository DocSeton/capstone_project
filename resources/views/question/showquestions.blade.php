        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h4 class="card-title">Attendee Table </h4>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td id = "id" value = "{{ $question->id }}">{{ $question->id }}</td>
                  <td id = "questionnaire_id" value = "{{ $question->questionnaire_id }}">{{ $question->questionnaire_id }}</td>
                  <td id = "question" value = "{{ $question->question }}">{{ $question->question }}</td>
                  <td id = "created_at" value = "{{ $question->created_at }}">{{ $question->created_at }}</td>
                  <td id = "updated_at" value = "{{ $question->updated_at }}">{{ $question->updated_at }}</td>

                  <!-- Delete Modal -->
                                    <td><a href="#" class = "btn btn-outline-danger" data-toggle="modal" data-target="#myModaldelete-{{ $question->id }}">Delete</a>




                                      <div id="myModaldelete-{{ $question->id }}" class="modal fade" role="dialog">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <strong>ID:</strong> <input type="text" name="id" value="{{ $question->id }}" class = "form-control">
                                              <strong>Title:</strong> <input type="text" name="questionnaire_id" value="{{ $question->questionnaire_id }}" class = "form-control">
                                              <strong>Title:</strong> <input type="text" name="question" value="{{ $question->question }}" class = "form-control">


                                              <br>
                                              <a href="{{ route('attendance.delete',$question->id) }}" class="btn btn btn-danger" style = "margin-left:320px;">Delete</a>
