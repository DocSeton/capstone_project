      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h4>
              <i class="fas fa-file-invoice"></i> CAS Summary Reports
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                <br>
                <b>College: </b>College of Arts and Sciences<br>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td id = "name" value = "{{ $eventusers->name }}">{{ $eventusers->name }} {{ $eventusers->middlename }} {{ $eventusers->lastname }}</td>
