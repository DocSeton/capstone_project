        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h4 class="card-title"><h3>Attendance Table</h3></h4>
            </div>
            <div class="">
            <p>     </p>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td id = "id" value = "{{ $questionnaire->id }}">{{ $questionnaire->id }}</td>
                  <td id = "author" value = "{{ $questionnaire->author }}">{{ $questionnaire->author }}</td>
                  <td id = "title" value = "{{ $questionnaire->title }}">{{ $questionnaire->title }}</td>
                  <td id = "event" value = "{{ $questionnaire->event }}">{{ $questionnaire->event }}</td>
                  ...
                  <td><a href="/questionnaire/{{ $questionnaire->id }}" class = "btn btn-outline-info">Add Student</a></td>

<!-- View Modal -->
                  <td><a href="#" class = "btn btn-success" data-toggle="modal" data-target="#myModalview-{{ $questionnaire->id }}">View</a>

                    <div id="myModalview-{{ $questionnaire->id }}" class="modal fade" role="dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>ID: <strong>{{ $questionnaire->id }}</strong></p>
                          <p>Author: <strong>{{ $questionnaire->author }}</strong></p>
                          <p>Title: <strong>{{ $questionnaire->title }}</strong></p>
                          <p>Created At: <strong>{{ $questionnaire->created_at }}</strong></p>
                          <p>Updated At: <strong>{{ $questionnaire->updated_at }}</strong></p>
...
<!-- Delete Modal -->
                  <td><a href="#" class = "btn btn-danger" data-toggle="modal" data-target="#myModaldelete-{{ $questionnaire->id }}">Delete</a>


                                        <div id="myModaldelete-{{ $questionnaire->id }}" class="modal fade" role="dialog">
                                          <div class="modal-dialog">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <strong>ID:</strong> <input type="text" name="id" value="{{ $questionnaire->id }}" class = "form-control">
                                                <strong>Author:</strong> <input type="text" name="author" value="{{ Auth::user()->name }}" class = "form-control">
                                                <strong>Title:</strong> <input type="text" name="title" value="{{ $questionnaire->title }}" class = "form-control">
                                                <strong>Event:</strong> <input type="text" name="title" value="{{ $questionnaire->event }}" class = "form-control">
                                                <strong>Created At:</strong> <input type="text" name="date_from" value="{{ $questionnaire->created_at }}" class = "form-control">
                                                <strong>Updated At</strong> <input type="text" name="date_to" value="{{ $questionnaire->updated_at }}" class = "form-control">


                                                <br>
                                                <a href="#" class="btn btn btn-danger" style = "margin-left:320px;">Delete</a>
