          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                @foreach($userevent as $usere)
                <tr>
                  <td id = "id" value = "{{ $usere->id }}">{{ $usere->id }}</td>
                  <td id = "department" value = "{{ $usere->event }}">{{ $usere->event }}</td>
                  <td id = "author" value = "{{ $usere->department }}">{{ $usere->department }}</td>
                  <td id = "author" value = "{{ $usere->author }}">{{ $usere->author }}</td>
                  <td id = "status" value = "{{ $usere->status }}"><b style="color:#2eb82e;">{{ $usere->status }}</b></td>
