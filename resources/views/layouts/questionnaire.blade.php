...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style = "background-color:#206020;">
    ...
    <a href="{{ url('/admin') }}" class="brand-link">
      <img src="{{ asset('dist/img/wupees.png') }}" alt="WUPEES" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ ('showquestionnaire') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Questionnaires</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ ('showanswers') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Choices</p>
                </a>
              </li>
      <!--
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Matrix (Single choice)</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Matrix (Multiple Choice)</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
...
<script type="text/javascript">
    ...
    $('#addRow').click(function () {
        ...
        html += '<button id="removeRow" type="button" class="btn btn-danger">&times;</button>';
        html += '</div>';
        html += '</div>';
    ...
    $(document).on('click', '#removeRow', function () {
      ...
      $('#addCardRow').click(function () {
        ...
        html += '                    <div class="input-group mb-3">';
        html += '                        <input type="text" name="titleCard[]" data-indexval=' + index + ' class="form-control m-input" placeholder="Enter title criteria" autocomplete="off">';
        html += '                       <button id="removeCardRow" type="button" data-indexval=' + index + ' onclick="removeCard(this)" class="btn btn-danger"><span class="fa fa-trash"></span></button>';
        html += '                   </div>';
        html += '                </div>';
        ...
        html += '                                    <div class="input-group-append"> ';
        html += '                                        <button id="removeCardQuestionRow" type="button" onclick="removeQuestion(this)" class="btn btn-danger"><span class="fa fa-trash"></span></button>';
        html += '                                    </div>';
        html += '                                </div>';
        html += '                            </div>';
        html += '                            <div id="newQuestionRow' +  index + '"></div>';
        html += '                           <button id="addCardQuestionRow" type="button" data-cardindexval=' + index + '  onclick="addQuestion(this)" class="btn btn-info"><span class="fa fa-plus"></span> Add Question</button>';
        html += '                        </div>';
        html += '                    </div>';
        html += '                </div>';
        html += '            </div>';
