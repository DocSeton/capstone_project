          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td id = "id" value = "{{ $user->id }}">{{ $user->id }}</td>
                  <td id = "name" value = "{{ $user->name }}{{ $user->middlename }}{{ $user->lastname }}">{{ $user->name }} {{ $user->middlename }} {{ $user->lastname }}</td>
                  <td id = "email" value = "{{ $user->email }}">{{ $user->email }}</td>
                  <td id = "department" value = "{{ $user->department }}">{{ $user->department }}</td>
                  <td id = "role" value = "{{ $user->role }}">{{ $user->role }}</td>
                  <td id = "created_at" value = "{{ $user->created_at }}">{{ $user->created_at }}</td>
                  <td id = "updated_at" value = "{{ $user->updated_at }}">{{ $user->updated_at }}</td>
                </tr>
                @endforeach
              </tbody>
                <tfoot>
