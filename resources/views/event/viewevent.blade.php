          ...
          <div class="card">
           ...
           <!--  <th>Created At</th>
                ...
                <tr>
                  ...
                  <td id = "date" value = "{{ $event->date_from }}">{{ date('m-d-Y', strtotime($event->date_from)) }} - {{ date('m-d-Y', strtotime($event->date_to)) }}</td>
                  <td id = "time_start" value = "{{ $event->time_start }}">{{ $event->time_start }} - {{ $event->time_end }}</td>
                    ...
                    <div id="myModalview-{{ $event->id }}" class="modal fade" role="dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <p>Duration: <strong>{{ date('m-d-Y', strtotime($event->date_from)) }} - {{ date('m-d-Y', strtotime($event->date_to)) }}</strong></p>
                          <p>Time Start: <strong>{{ $event->time_start }} - {{ $event->time_end }}</strong></p>
