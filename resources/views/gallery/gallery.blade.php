...
<div class="container-fluid">
  ...
  <div class="col-12">
    <div class="card">
    <div class="card-header" style="text-align:center;"><h2>Event Gallery</h2></div>
        ...
        <!--
          ...
          <div class="row">
            ...
            @foreach($images as $image)
                      ...
                      <div class="col-sm-2">
                        <a href="{{ route('gallery.uploadedgallerylinks') }}" class="btn btn-default" style="float:right;margin-right:4px;margin-top:4px;"><i class="fas fa-edit"></i></a>
