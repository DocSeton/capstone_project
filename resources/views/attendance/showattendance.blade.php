        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h4 class="card-title"><h2>Attendance Table</h2></h4>
            </div>
            <div class="">
            <p>     </p>
            </div>
            <div>
              <a href="javascript:window.print();" class="btn btn-default btn-block"><i class="fa fa-print"></i> Print Reports</a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td id = "attendee" value = "{{ $event->attendee }}">{{ $event->attendee }}</td>
                  <td id = "attendee_attendance_status" value = "{{ $event->attendee_attendance_status }}" style="color:#33cc33;">{{ $event->attendee_attendance_status }}</td>
                  <td id = "title" value = "{{ $event->title }}">{{ $event->title }}</td>
                  <td id = "venue" value = "{{ $event->venue }}">{{ $event->venue }}</td>
                  <td id = "author" value = "{{ $event->author }}">{{ $event->author }}</td>
                  <td id = "department" value = "{{ $event->department }}">{{ $event->department }}</td>
                  <td id = "duration" value = "{{ $event->duration }}">{{ $event->duration }}</td>
                  <td id = "time_start" value = "{{ $event->time_start }}">{{ $event->time_start }}</td>
                  <td id = "time_end" value = "{{ $event->time_end }}">{{ $event->time_end }}</td>
                  <td id = "in_or_out" value = "{{ $event->in_or_out }}">{{ $event->in_or_out }}</td>
