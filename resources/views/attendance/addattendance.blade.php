        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h4 class="card-title">Add Attendance Table</h4>
            </div>
            <div class="">
            <p>     </p>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td id = "college" value = "{{ $event->department }}">{{ $event->department }}</td>
                  <td id = "college" value = "{{ $event->date_from }} - {{ $event->date_from }}">{{ $event->date_from }} - {{ $event->date_from }}</td>
                  ...
                  <td><a href="{{ route('attendance.addstudent',[$event->id]) }}" class = "btn btn-outline-primary">Add</a></td>
