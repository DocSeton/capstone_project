        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Posted Events Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td id = "image" value = "{{ asset('storage/images/posts/'. $event->image) }}"><img class="img-fluid pad" src="{{ asset('storage/images/posts/'. $event->image) }}" alt="No current event photo" style="height:80px;width:50px;"></td>
